...
class IssueTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create issue_type" do
    assert_difference('IssueType.count') do
      post issue_types_url, params: { issue_type: { issueTypeName: @issue_type.issueTypeName } }
    end
  ...
  test "should update issue_type" do
    patch issue_type_url(@issue_type), params: { issue_type: { issueTypeName: @issue_type.issueTypeName } }
